...
namespace Authorize.Net.CP
{
    ...
    public class CardPresentResponse : ResponseBase, IGatewayResponse
    {
        ...
        public string UserReference => ParseResponse(9);

        /// <summary>
        ///     Gets the MD5 hash.
        /// </summary>
        /// <value>The MD5 hash.</value>
        public string MD5Hash => ParseResponse(8);

        /// <summary>
        ///     Gets the split tender ID.
        /// </summary>
        /// <value>The split tender ID.</value>
        public string SplitTenderID => ParseResponse(22);

        /// <summary>
        ///     Gets the remaining balance on card.
        /// </summary>
        /// <value>The remaining balance on card.</value>
        public decimal RemainingBalanceOnCard => ParseDecimal(25);

        /// <summary>
        ///     Gets the requested amount.
        /// </summary>
        /// <value>The requested amount.</value>
        public decimal RequestedAmount => ParseDecimal(23);
        ...
        public decimal Amount => ParseDecimal(24);
        ...
        public bool Approved => ParseInt(1) == 1;
        ...
        public string InvoiceNumber => ParseResponse(9);

        /// <summary>
        ///     Gets the card number.
        /// </summary>
        /// <value>The card number.</value>
        public string CardNumber => ParseResponse(20);

        /// <summary>
        ///     Gets the response code.
        /// </summary>
        /// <value>The response code.</value>
        public string ResponseCode => ParseResponse(1);
        ...
        public string TransactionID => ParseResponse(7);
