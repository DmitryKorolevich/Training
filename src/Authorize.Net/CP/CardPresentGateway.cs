...
namespace Authorize.Net.CP
{
    ...
    {
        private readonly DeviceType _deviceType = DeviceType.PersonalComputerBasedTerminal;
        private readonly string _marketType = "2";

        private readonly string _serviceUrl = "https://cardpresent.authorize.net/gateway/transact.dll";
        ...
        /// <returns></returns>
        public override async Task<IGatewayResponse> Send(IGatewayRequest request, string description)
        {
            ...
            var response = await SendRequest(_serviceUrl, request);
