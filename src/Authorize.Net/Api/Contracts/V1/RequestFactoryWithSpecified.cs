...
namespace Authorize.Net.Api.Contracts.V1
{
    ...
    public static class RequestFactoryWithSpecified
    {
        ...
        public static void ARBSubscriptionMaskedType(ARBSubscriptionMaskedType argument)
        {
            if (null != argument)
            {
                ...
                if (0 <= argument.amount)
                {
                    argument.amountSpecified = true;
                }
                if (0 <= argument.trialAmount)
                {
                    argument.trialAmountSpecified = true;
                }
                if (0 <= argument.status)
                {
                    argument.statusSpecified = true;
                }
        ...
        public static void paymentSimpleType(paymentSimpleType argument)
        {
            if (null != argument)
            {
                if (argument.Item is bankAccountType)
                {
                    bankAccountType(argument.Item as bankAccountType);
                }
                if (argument.Item is creditCardSimpleType)
                {
                    creditCardSimpleType(argument.Item as creditCardSimpleType);
                }
            }
        }
        ...
        public static void bankAccountType(bankAccountType argument)
        {
            if (null != argument)
            {
                if (0 <= (int) argument.accountType)
                {
                    argument.accountTypeSpecified = true;
                }
                if (0 <= (int) argument.echeckType)
                {
                    argument.echeckTypeSpecified = true;
                }
            }
        }
        ...
        public static void creditCardType(creditCardType argument)
        {
            if (null != argument)
            {
                ...
                if (argument.isPaymentToken)
                {
                    argument.isPaymentTokenSpecified = true;
                }
            }
        }
        ...
        public static void mobileDeviceType(mobileDeviceType argument)
        {
            if (null != argument)
            {
                if (0 <= (int) argument.deviceActivation)
                {
                    argument.deviceActivationSpecified = true;
                }
            }
        }
        ...
        public static void transactionSummaryType(transactionSummaryType argument)
        {
            if (null != argument)
            {
                ...
                if (argument.hasReturnedItems)
                {
                    argument.hasReturnedItemsSpecified = true;
                }
            }
        }
        ...
        public static void messagesType(messagesType argument)
        {
            if (null != argument)
            {
                if (null != argument.message)
                {
                    foreach (var value in argument.message)
                    {
                        messagesTypeMessage(value);
                    }
                }
            }
        }
        ...
        public static void ArrayOfSetting(ArrayOfSetting argument)
        {
            if (null != argument)
            {
                if (null != argument.setting)
                {
                    foreach (var value in argument.setting)
                    {
                        settingType(value);
                    }
                }
        ...
        public static void customerProfilePaymentType(customerProfilePaymentType argument)
        {
            if (null != argument)
            {
                if (argument.createProfile)
                {
                    argument.createProfileSpecified = true;
                }
        ...
        public static void transactionRequestType(transactionRequestType argument)
        {
            if (null != argument)
            {
                ...
                orderType(argument.order);
                if (null != argument.lineItems)
                {
                    foreach (var value in argument.lineItems)
                    {
                        lineItemType(value);
                    }
                }
                ...
                if (argument.taxExempt)
                {
                    argument.taxExemptSpecified = true;
                }
                ...
                if (null != argument.transactionSettings)
                {
                    foreach (var value in argument.transactionSettings)
                    {
                        settingType(value);
                    }
                }
                if (null != argument.userFields)
                {
                    foreach (var value in argument.userFields)
                    {
                        userField(value);
                    }
                }
        ...
        public static void paymentType(paymentType argument)
        {
            if (null != argument)
            {
                ...
                if (argument.Item is creditCardType)
                {
                    creditCardType(argument.Item as creditCardType);
                }
                if (argument.Item is encryptedTrackDataType)
                {
                    encryptedTrackDataType(argument.Item as encryptedTrackDataType);
                }
                if (argument.Item is opaqueDataType)
                {
                    opaqueDataType(argument.Item as opaqueDataType);
                }
                if (argument.Item is payPalType)
                {
                    payPalType(argument.Item as payPalType);
                }
                if (argument.Item is creditCardTrackType)
                {
                    creditCardTrackType(argument.Item as creditCardTrackType);
                }
            }
        }
        ...
        public static void customerDataType(customerDataType argument)
        {
            if (null != argument)
            {
                if (0 <= (int) argument.type)
                {
                    argument.typeSpecified = true;
                }
        ...
        public static void batchStatisticType(batchStatisticType argument)
        {
            if (null != argument)
            {
                if (0 <= argument.returnedItemAmount)
                {
                    argument.returnedItemAmountSpecified = true;
                }
                if (0 <= argument.returnedItemCount)
                {
                    argument.returnedItemCountSpecified = true;
                }
                if (0 <= argument.chargebackAmount)
                {
                    argument.chargebackAmountSpecified = true;
                }
                if (0 <= argument.chargebackCount)
                {
                    argument.chargebackCountSpecified = true;
                }
                if (0 <= argument.correctionNoticeCount)
                {
                    argument.correctionNoticeCountSpecified = true;
                }
                if (0 <= argument.chargeChargeBackAmount)
                {
                    argument.chargeChargeBackAmountSpecified = true;
                }
                if (0 <= argument.chargeChargeBackCount)
                {
                    argument.chargeChargeBackCountSpecified = true;
                }
                if (0 <= argument.refundChargeBackAmount)
                {
                    argument.refundChargeBackAmountSpecified = true;
                }
                if (0 <= argument.refundChargeBackCount)
                {
                    argument.refundChargeBackCountSpecified = true;
                }
                if (0 <= argument.chargeReturnedItemsAmount)
                {
                    argument.chargeReturnedItemsAmountSpecified = true;
                }
                if (0 <= argument.chargeReturnedItemsCount)
                {
                    argument.chargeReturnedItemsCountSpecified = true;
                }
                if (0 <= argument.refundReturnedItemsAmount)
                {
                    argument.refundReturnedItemsAmountSpecified = true;
                }
                if (0 <= argument.refundReturnedItemsCount)
                {
                    argument.refundReturnedItemsCountSpecified = true;
                }
            }
        }
        ...
        public static void batchDetailsType(batchDetailsType argument)
        {
            if (null != argument)
            {
                if (DateTime.MinValue != argument.settlementTimeUTC)
                {
                    argument.settlementTimeUTCSpecified = true;
                }
                if (DateTime.MinValue != argument.settlementTimeLocal)
                {
                    argument.settlementTimeLocalSpecified = true;
                }
                if (null != argument.statistics)
                {
                    foreach (var value in argument.statistics)
                    {
                        batchStatisticType(value);
                    }
                }
            }
        }
        ...
        public static void transactionDetailsType(transactionDetailsType argument)
        {
            ...
            {
                subscriptionPaymentType(argument.subscription);
                if (null != argument.FDSFilters)
                {
                    foreach (var value in argument.FDSFilters)
                    {
                        FDSFilterType(value);
                    }
                }
                ...
                if (0 <= argument.requestedAmount)
                {
                    argument.requestedAmountSpecified = true;
                }
                extendedAmountType(argument.tax);
                extendedAmountType(argument.shipping);
                extendedAmountType(argument.duty);
                ...
                if (0 <= argument.prepaidBalanceRemaining)
                {
                    argument.prepaidBalanceRemainingSpecified = true;
                }
                if (argument.taxExempt)
                {
                    argument.taxExemptSpecified = true;
                ...
                if (null != argument.returnedItems)
                {
                    foreach (var value in argument.returnedItems)
                    {
                        returnedItemType(value);
                    }
                }
                solutionType(argument.solution);
            }
        ...
        public static void paymentMaskedType(paymentMaskedType argument)
        {
            if (null != argument)
            {
                if (argument.Item is bankAccountMaskedType)
                {
                    bankAccountMaskedType(argument.Item as bankAccountMaskedType);
                }
                if (argument.Item is creditCardMaskedType)
                {
                    creditCardMaskedType(argument.Item as creditCardMaskedType);
                }
        ...
        public static void bankAccountMaskedType(bankAccountMaskedType argument)
        {
            if (null != argument)
            {
                if (0 <= argument.accountType)
                {
                    argument.accountTypeSpecified = true;
                }
                if (0 <= argument.echeckType)
                {
                    argument.echeckTypeSpecified = true;
                }
            }
        ...
        public static void transactionResponse(transactionResponse argument)
        {
            if (null != argument)
            {
                ...
                if (null != argument.messages)
                {
                    foreach (var value in argument.messages)
                    {
                        transactionResponseMessage(value);
                    }
                }
                if (null != argument.errors)
                {
                    foreach (var value in argument.errors)
                    {
                        transactionResponseError(value);
                    }
                }
                if (null != argument.splitTenderPayments)
                {
                    foreach (var value in argument.splitTenderPayments)
                    {
                        transactionResponseSplitTenderPayment(value);
                    }
                }
                if (null != argument.userFields)
                {
        ...
        public static void profileTransactionType(profileTransactionType argument)
        {
            if (null != argument)
            {
                if (argument.Item is profileTransAuthCaptureType)
                {
                    profileTransAuthCaptureType(argument.Item as profileTransAuthCaptureType);
                }
                if (argument.Item is profileTransAuthOnlyType)
                {
                    profileTransAuthOnlyType(argument.Item as profileTransAuthOnlyType);
                }
                if (argument.Item is profileTransCaptureOnlyType)
                {
                    profileTransCaptureOnlyType(argument.Item as profileTransCaptureOnlyType);
                }
                if (argument.Item is profileTransPriorAuthCaptureType)
                {
                    profileTransPriorAuthCaptureType(argument.Item as profileTransPriorAuthCaptureType);
                }
                if (argument.Item is profileTransRefundType)
                {
                    profileTransRefundType(argument.Item as profileTransRefundType);
                }
                if (argument.Item is profileTransVoidType)
                {
                    profileTransVoidType(argument.Item as profileTransVoidType);
                }
            }
        }
        ...
        public static void customerPaymentProfileBaseType(customerPaymentProfileBaseType argument)
        {
            if (null != argument)
            {
                if (0 <= argument.customerType)
                {
                    argument.customerTypeSpecified = true;
                }
                customerAddressType(argument.billTo);
            }
        }
        ...
        public static void customerProfileMaskedType(customerProfileMaskedType argument)
        {
            if (null != argument)
            {
                ...
                {
                    foreach (var value in argument.paymentProfiles)
                    {
                        customerPaymentProfileMaskedType(value);
                    }
                }
                if (null != argument.shipToList)
                {
                    foreach (var value in argument.shipToList)
                    {
                        customerAddressExType(value);
                    }
                }
            }
        }
        ...
        public static void customerProfileType(customerProfileType argument)
        {
            if (null != argument)
            {
                ...
                if (null != argument.paymentProfiles)
                {
                    foreach (var value in argument.paymentProfiles)
                    {
                        customerPaymentProfileType(value);
                    }
                }
                if (null != argument.shipToList)
                {
        ...
        public static void paymentScheduleType(paymentScheduleType argument)
        {
            if (null != argument)
            {
                ...
                if (DateTime.MinValue != argument.startDate)
                {
                    argument.startDateSpecified = true;
                }
                if (0 <= argument.totalOccurrences)
                {
                    argument.totalOccurrencesSpecified = true;
                }
                if (0 <= argument.trialOccurrences)
                {
                    argument.trialOccurrencesSpecified = true;
                }
            }
        }
        ...
        public static void merchantAuthenticationType(merchantAuthenticationType argument)
        {
            if (null != argument)
            {
                ...
                if (argument.Item is impersonationAuthenticationType)
                {
        ...
        public static void createCustomerProfileRequest(createCustomerProfileRequest argument)
        {
            if (null != argument)
            {
                ...
                if (0 <= argument.validationMode)
                {
                    argument.validationModeSpecified = true;
                }
            }
        }
        ...
        public static void getSettledBatchListRequest(getSettledBatchListRequest argument)
        {
            if (null != argument)
            {
                if (argument.includeStatistics)
                {
                    argument.includeStatisticsSpecified = true;
                }
                if (DateTime.MinValue != argument.firstSettlementDate)
                {
                    argument.firstSettlementDateSpecified = true;
                }
                if (DateTime.MinValue != argument.lastSettlementDate)
                {
                    argument.lastSettlementDateSpecified = true;
                }
            }
        }
        ...
        public static void getSettledBatchListResponse(getSettledBatchListResponse argument)
        {
            if (null != argument)
            {
                if (null != argument.batchList)
                {
                    foreach (var value in argument.batchList)
                    {
                        batchDetailsType(value);
                    }
                }
            }
        }
        ...
        public static void getHostedProfilePageRequest(getHostedProfilePageRequest argument)
        {
            if (null != argument)
            {
                if (null != argument.hostedProfileSettings)
                {
                    foreach (var value in argument.hostedProfileSettings)
                    {
                        settingType(value);
                    }
                }
        ...
        public static void mobileDeviceLoginResponse(mobileDeviceLoginResponse argument)
        {
            if (null != argument)
            {
                ...
                if (null != argument.userPermissions)
                {
                    foreach (var value in argument.userPermissions)
                    {
        ...
        public static void ARBGetSubscriptionListResponse(ARBGetSubscriptionListResponse argument)
        {
            if (null != argument)
            {
                ...
                if (null != argument.subscriptionDetails)
                {
                    foreach (var value in argument.subscriptionDetails)
                    {
        ...
        public static void getCustomerPaymentProfileListResponse(getCustomerPaymentProfileListResponse argument)
        {
            if (null != argument)
            {
                if (null != argument.paymentProfiles)
                {
                    foreach (var value in argument.paymentProfiles)
                    {
                        customerPaymentProfileListItemType(value);
                    }
                }
            }
        }
