...
namespace Authorize.Net.Utility
{
    ...
    public class ApiFields
    {
        ...
        /// <summary>
        ///     The credit card number - between 13 and 16 digits without spaces. When x_type=CREDIT, only the last four digits are
        ///     required
        /// </summary>
        ...
        /// <summary>
        ///     The payment gateway assigned transaction ID of an original transaction - Required only for CREDIT, PRIOR_ AUTH_
        ///     CAPTURE, and VOID transactions
        /// </summary>
        public const string TransactionID = "x_trans_id";

        /// <summary>
        ///     The payment gateway-assitned ID assigned when the original transaction includes  two or more partial payments. This
        ///     is the identifier that is used to group transactions that are part of a split tender order.
        /// </summary>
