...
namespace VitalChoice.Business.Services.Products
{
    public class PromotionService : ExtendedEcommerceDynamicService<PromotionDynamic, Promotion, PromotionOptionType, PromotionOptionValue>, IPromotionService
    {
        ...
        public PromotionService(
            ...
            ILoggerProviderExtended loggerProvider, DirectMapper<Promotion> directMapper, DynamicExpressionVisitor queryVisitor, ITransactionAccessor<EcommerceContext> transactionAccessor)
