...
namespace VitalChoice.Business.Services.Products
{
    public class DiscountService : ExtendedEcommerceDynamicService<DiscountDynamic, Discount, DiscountOptionType, DiscountOptionValue>, IDiscountService
    {
        ...
        public DiscountService(
            ...
            ILoggerProviderExtended loggerProvider, DirectMapper<Discount> directMapper, DynamicExpressionVisitor queryVisitor, ITransactionAccessor<EcommerceContext> transactionAccessor)
