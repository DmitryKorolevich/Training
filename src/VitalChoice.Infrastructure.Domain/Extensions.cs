...
namespace VitalChoice.Infrastructure.Domain
{
    ...
    {
        public static ServiceBusCommandBase CreateResult(this ServiceBusCommandBase command, object data)
            => new ServiceBusCommandBase(command, data);

        public static ServiceBusCommandBase CreateError(this ServiceBusCommandBase command, string error)
            => new ServiceBusCommandBase(command, error);
