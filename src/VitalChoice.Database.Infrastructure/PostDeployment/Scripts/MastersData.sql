...
IF EXISTS(SELECT [Id] FROM [dbo].[MasterContentItems] WHERE [Name] = 'Product sub categories'
AND Updated < '2015-12-28 00:00:00.000')
BEGIN
	UPDATE MasterContentItems
	SET
	[Updated] = GETDATE(),
	[Template] = N'@using() {{VitalChoice.Infrastructure.Domain.Transfer.TemplateModels}}
@using() {{System.Linq}}
@model() {{dynamic}}
...
IF EXISTS(SELECT [Id] FROM [dbo].[MasterContentItems] WHERE Template not like N'%<a href="#" id="lnkAddToCart">%' AND [Name] = 'Product page')
BEGIN
	UPDATE [dbo].[MasterContentItems]
	SET [Template] = N'@using() {{VitalChoice.Infrastructure.Domain.Transfer.TemplateModels.ProductPage}}
@using() {{System.Linq}}
...
IF EXISTS(SELECT [Id] FROM [dbo].[MasterContentItems] WHERE Template like N'%<section class="product-detais">%' AND [Name] = 'Product page')
BEGIN
	UPDATE [dbo].[MasterContentItems]
	SET [Template] = N'@using() {{VitalChoice.Infrastructure.Domain.Transfer.TemplateModels.ProductPage}}
@using() {{System.Linq}}
