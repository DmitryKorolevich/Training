...
namespace VitalChoice.Domain.Entities
{
    ...
    {
        public static void CreateSubCategoriesList(this ContentCategory root, IEnumerable<ContentCategory> heapCategories)
        {
        ...
        public static void CreateSubCategoriesList(this ProductCategory root, IEnumerable<ProductCategory> heapCategories)
        {
            if (root.SubCategories == null)
            {
                var subCategories = heapCategories.Where(p => p.ParentId == root.Id);
