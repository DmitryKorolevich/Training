		...
		return {
			...
			link: function(scope, element, attrs, ngModel){
				...
				scope.switchView = function(){
					...
					$animate.enabled(scope.displayElements.html, false);
					$animate.enabled(scope.displayElements.text, false);
					//Show the HTML view
					if(scope.showHtml){
						//defer until the element is visible
						$timeout(function(){
						    $animate.enabled(scope.displayElements.html, true);
						    $animate.enabled(scope.displayElements.text, true);
