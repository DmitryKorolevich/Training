...
.controller('profileScopesController', ['$scope', '$state', '$stateParams', 'settingService', 'toaster', 'modalUtil', 'confirmUtil', 'promiseTracker', 'gridSorterUtil',
function ($scope, $state, $stateParams, settingService, toaster, modalUtil, confirmUtil, promiseTracker, gridSorterUtil) {
    ...
    function initialize() {
        ...
        $scope.filter = {
            ...
            Sorting: gridSorterUtil.resolve(refreshItems, "TimeElapsed", "Desc")
        };
