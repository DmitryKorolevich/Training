...
.controller('contentPagesController', ['$scope', '$state', 'contentService', 'toaster', 'modalUtil', 'confirmUtil','promiseTracker','gridSorterUtil',
	...
	function initialize() {
	    $scope.filter = {
            ...
            Sorting: gridSorterUtil.resolve(refreshContentPages, "Updated", "Desc")
	    };
        $scope.loaded=false;
