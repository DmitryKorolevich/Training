...
.controller('gcDetailController', ['$scope', '$rootScope', '$state', '$stateParams', 'gcService', 'toaster', 'modalUtil', 'confirmUtil', 'promiseTracker',
function ($scope, $rootScope, $state, $stateParams, gcService, toaster, modalUtil, confirmUtil, promiseTracker) {
