angular.module('app.modules.inventorysku.controllers.inventorySkuCategoriesController', [])
.controller('inventorySkuCategoriesController', ['$scope', '$state', '$stateParams', 'inventorySkuService', 'toaster', 'modalUtil', 'confirmUtil', 'promiseTracker',
    function ($scope, $state, $stateParams, inventorySkuService, toaster, modalUtil, confirmUtil, promiseTracker)
    {
    ...
    $scope.edit = function (id) {
        modalUtil.open('app/modules/inventorysku/partials/inventorySkuCategoryDetail.html', 'inventorySkuCategoryManageController', {
    ...
    $scope.delete = function (id) {
        confirmUtil.confirm(function () {
            inventorySkuService.deleteInventorySkuCategory(id, $scope.deleteTracker)
			    .success(function (result) {
			        if (result.Success) {
    ...
    $scope.save = function () {
        inventorySkuService.updateInventorySkuCategoriesTree($scope.rootCategories, $scope.editTracker)
            .success(function (result) {
                if (result.Success) {
