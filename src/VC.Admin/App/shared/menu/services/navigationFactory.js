			...
			subMenu: [
				...
				},
				{
				    ...
				    subMenu: [
                        ...
                        { name: 'affiliateOrderImportReport', stateName: 'index.oneCol.affiliateOrderImportReport', stateLabel: 'CJ Affiliate Order Status Upload', access: 3 },
				    ]
				},
				{
				    name: 'operations',
				    ...
				    subMenu: [
                        ...
                        { name: 'orderAbuseReport', stateName: 'index.oneCol.orderAbuseReport', stateLabel: 'Customer Account Refund/Reship Report', access: 3 },
                        ...
                        { name: 'serviceCodesStatistic', stateName: 'index.oneCol.serviceCodesStatistic', stateLabel: 'Service Codes Report', access: 3 },
                        { name: 'skuInventoriesInfoList', stateName: 'index.oneCol.skuInventoriesInfoList', stateLabel: 'SKU Part Summary List', access: 3 }
				    ]
				},
				{
