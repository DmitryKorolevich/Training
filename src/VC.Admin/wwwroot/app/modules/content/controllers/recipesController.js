...
.controller('recipesController', ['$scope', '$state', 'contentService', 'toaster', 'modalUtil', 'confirmUtil','promiseTracker','gridSorterUtil',
	...
	function initialize() {
	    $scope.filter = {
            ...
            Sorting: gridSorterUtil.resolve(refreshRecipes, "Updated", "Desc")
	    };
        $scope.loaded=false;
