...
.controller('faqsController', ['$scope', '$state', 'contentService', 'toaster', 'modalUtil', 'confirmUtil', 'promiseTracker', 'gridSorterUtil',
	...
	function initialize() {
	    $scope.filter = {
            ...
            Sorting: gridSorterUtil.resolve(refreshFaqs, "Updated", "Desc")
	    };
        $scope.loaded=false;
