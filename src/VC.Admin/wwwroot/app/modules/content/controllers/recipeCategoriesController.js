...
.controller('recipeCategoriesController', ['$scope', '$state', '$stateParams', 'contentService', 'toaster', 'modalUtil', 'confirmUtil', function ($scope, $state, $stateParams, contentService, toaster, modalUtil, confirmUtil) {
