...
namespace VitalChoice.Infrastructure.Identity.UserManagers
{
    ...
    public class AffiliateUserManager : UserManager<ApplicationUser>
    {
        public AffiliateUserManager(IUserStore<ApplicationUser> store, IOptions<IdentityOptions> optionsAccessor,
