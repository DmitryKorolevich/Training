...
namespace VitalChoice.Infrastructure.Identity
{
    ...
    {
	    public ExtendedClaimsPrincipalFactory(UserManager<ApplicationUser> userManager, RoleManager<ApplicationRole> roleManager, IOptions<IdentityOptions> optionsAccessor) : base(userManager, roleManager, optionsAccessor)
	    {
	    }
	    ...
	    public override async Task<ClaimsPrincipal> CreateAsync(ApplicationUser user)
	    {
			...
			ClaimsIdentity id = new ClaimsIdentity(this.Options.Cookies.ApplicationCookieAuthenticationScheme, this.Options.ClaimsIdentity.UserNameClaimType, this.Options.ClaimsIdentity.RoleClaimType);
