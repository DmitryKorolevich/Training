...
namespace VitalChoice.Infrastructure.Context
{
	public class EcommerceContext : DataContext
    {
		...
		protected override void OnModelCreating(ModelBuilder builder)
		{
			...
			builder.Entity<CustomerToOrderNote>().ForSqlServer().Table("CustomersToOrderNotes");
			...
			builder.Entity<CustomerToPaymentMethod>().ForSqlServer().Table("CustomersToPaymentMethods");
