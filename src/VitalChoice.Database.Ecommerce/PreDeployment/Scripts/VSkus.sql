...
SELECT 
	...
	LEFT JOIN ProductOptionValues AS aval1 ON aval1.IdSku = s.Id AND aval1.IdOptionType = aopt1.Id
	LEFT JOIN ProductOptionTypes AS aopt2 ON aopt2.Name = N'AutoShipFrequency2' AND aopt2.IdObjectType = p.IdObjectType
	LEFT JOIN ProductOptionValues AS aval2 ON aval2.IdSku = s.Id AND aval2.IdOptionType = aopt2.Id
