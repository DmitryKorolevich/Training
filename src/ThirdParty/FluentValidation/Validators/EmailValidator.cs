...
namespace FluentValidation.Validators {
	...
	public class EmailValidator : PropertyValidator, IRegularExpressionValidator, IEmailValidator {
	    public static Regex RegexExpression { get; } = new Regex(expression, RegexOptions.Compiled | RegexOptions.IgnoreCase);
		...
		protected override bool IsValid(PropertyValidatorContext context) {
			...
			if (!RegexExpression.IsMatch((string)context.PropertyValue)) {
				return false;
			}
