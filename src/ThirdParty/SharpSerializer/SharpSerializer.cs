...
using System.Xml;
using SharpSerializer.Library.Advanced;
using SharpSerializer.Library.Advanced.Binary;
using SharpSerializer.Library.Advanced.Deserializing;
using SharpSerializer.Library.Advanced.Serializing;
using SharpSerializer.Library.Advanced.Xml;
using SharpSerializer.Library.Core;
using SharpSerializer.Library.Deserializing;
using SharpSerializer.Library.Serializing;

namespace SharpSerializer.Library
{
    /// <summary>
