namespace Azure.ApplicationHost.Constants
{
    ...
    internal static class FrameworkNames
    {
        public static class ShortNames
        {
            ...
            public const string net451 = Dnx + "451";
            public const string net461 = Dnx + "461";
        ...
        public static class LongNames
        {
            ...
            public const string net451 = Dnx + VersionPrefix + "4.5.1";
            public const string net461 = Dnx + VersionPrefix + "4.6.1";
